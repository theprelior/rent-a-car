...
import CarImage from "~/app/_components/CarImage"
          ...
          {cars.map((car) => (
            <div key={car.id.toString()} className="grid grid-cols-1 lg:grid-cols-12 gap-6 rounded-xl bg-neutral-900 p-6 shadow-lg transition-transform duration-300 hover:scale-[1.02] border border-transparent hover:border-yellow-500/30">
              ...
              <div className="lg:col-span-3">
                <div className="relative w-full rounded-lg bg-neutral-800 overflow-hidden
                  aspect-[4/3] sm:aspect-[16/9] lg:aspect-[4/3]">
                  <CarImage src={car.imageUrl ?? "/car-placeholder.png"} alt={`${car.marka} ${car.model}`} />
                </div>
              </div>
