...
export function CarDetailView({
    ...
    const shouldPlayVideo = (isHovered || isMobile) && !!car.previewVideoUrl;
    ...
    useEffect(() => {
        if (videoRef.current) {
            if (shouldPlayVideo) videoRef.current.play().catch(() => { });
    ...
    const handleBookingSubmit = (e: React.FormEvent) => {
        ...
        const companyPhoneNumber = "5444798594";
            ...
            <div className="container mx-auto px-4 py-12 space-y-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    <div className="lg:col-span-7">
                        <div
                            className="relative w-full h-64 sm:h-80 md:h-96 lg:h-[28rem] xl:h-[32rem] rounded-lg overflow-hidden shadow-lg shadow-yellow-500/10 bg-neutral-800"
                        ...
                        >
                            ...
                            {car.previewVideoUrl && (
                                <video
                                    ...
                                    playsInline
                                    preload="metadata"
                                    className={`absolute inset-0 w-full h-full object-cover transition-opacity duration-300 ${shouldPlayVideo ? "opacity-100" : "opacity-0"}`}
                                />
                            )}
                        </div>
                    </div>
